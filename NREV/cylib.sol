...
contract cylib {
    ...
    function hhToString(address account) public pure returns(string memory) {
        return hhToString(abi.encodePacked(account));
    }
    
    function hhToString(uint256 value) public pure returns(string memory) {
        return hhToString(abi.encodePacked(value));
    }
    
    function hhToString(bytes32 value) public pure returns(string memory) {
        return hhToString(abi.encodePacked(value));
    }
    
    function hhToString(bytes memory data) public pure returns(string memory) {
